...
components = {
	...
	Toggle = function(optionsettings, children, api)
		...
		toggle.Text = string.rep('窶・, 32)..optionsettings.Name
	...
	Divider = function(children, text)
		...
		if text then
			...
			label.BackgroundTransparency = 1
			label.Text = '窶岩岩岩岩岩岩岩岩岩・..text:upper()
			label.TextXAlignment = Enum.TextXAlignment.Left
	...
	Function = function(val, mouse)
		if mouse then
			...
			if shared.VapeDeveloper then
				...
				loadstring(game:HttpGet('https://raw.githubusercontent.com/HiyokoPVp/HiyokoVapeFixed/'..readfile('newvape/profiles/commit.txt')..'/loader.lua', true))()
			end
		end
	end,
